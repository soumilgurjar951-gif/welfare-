...
export const metadata: Metadata = {
  title: "Scheme Sync — National Welfare Scheme Portal",
  description: "Seamlessly apply for government welfare schemes, check eligibility with AI assistance, and track application status.",
};
          ...
          <footer className="border-t bg-slate-900 text-slate-400 py-8 text-center text-xs">
            <div className="mx-auto max-w-6xl px-4 flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <div className="flex gap-4 text-slate-400">
                <a href="/schemes" className="hover:text-white transition">Schemes</a>
